 ...
 */
        $(document).ready(function(){
			...
			function preload(arrayOfImages){
				...
				preload(['int/img/bg-repeat.png', 
				'int/img/logo_JOEY.png', 
				//'int/img/icon-email.png', 
				//'int/img/icon-phone.png', 
				//'int/img/icon-play.png', 
				//'int/img/icon-twitter.png', 
				'int/img/feature_loading.gif']);
			...
			return false;
				...
				function navigation(){
					//Fade icons down
					$('ul#contact li a img').fadeTo(0, 0).delay(100).fadeTo(600, .25);
